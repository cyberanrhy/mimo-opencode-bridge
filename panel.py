...
const LANG = {
  ...
  ru: {
    ...
    qi_control: 'управление процессом прокси',
    qi_test: 'отправить "say hi in 3 words" для проверки',
    qi_apikey: 'любой ключ (например "sk-proxy") или отключить в config.json',
    qi_models: 'mimo-auto (бесплатно), mimo-v2.5, mimo-v2.5-pro, mimo-v2.5-pro-ultraspeed, mimo-v2-flash',
    qi_requires: 'npm install -g @mimo-ai/cli',
    qi_status: '🟢 работает / 🔴 не отвечает / 🟡 проверка...',
    footer_refresh: 'F5 — обновить',
    online: 'РАБОТАЕТ',
    offline: 'НЕ ОТВЕЧАЕТ',
    checking: 'проверка...',
    unknown: 'неизвестно',
    ...
    toast_started: 'Прокси запущен',
    toast_stopped: 'Прокси остановлен',
    toast_restarted: 'Прокси перезапущен',
    toast_error: 'Ошибка',
  }
};
